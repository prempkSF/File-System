...
namespace SynCartFS
{
    ...
    public static class Operation
    {
        ...
        public static void LoadDefaultData()
        {
            ...
            orders.Add(new(customerID: customers.First().CustomerID, productID: products.First().ProductID, totalPrice: products.First().Price, purchaseDate: DateTime.Now, quantity: 1, orderStatus: OrderStatus.Ordered));
            products.First().Stock--;
        }
